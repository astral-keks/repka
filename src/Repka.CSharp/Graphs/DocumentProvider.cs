    ...
    public class DocumentProvider : GraphProvider
    {
        public override void AddTokens(GraphKey key, Graph graph)
        {
            ...
            if (directory.Exists)
            {
                ...
                Dictionary<AbsolutePath, List<ProjectNode>> projectsByDocuments = graph.Projects()
                ...
                Dictionary<AbsolutePath, List<ProjectNode>> projectsByDirectory = graph.Projects()
        ...
        private IEnumerable<GraphToken> GetDocumentTokens(FileInfo documentFile,
            ...
            Dictionary<AbsolutePath, List<ProjectNode>> projectsByDirectory)
        {
